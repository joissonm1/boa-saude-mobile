          ...
          {step === 'payment' && method === 'reference' && (
            <div className="space-y-6">
              ...
              <div className="bg-primary/5 border-2 border-primary/20 rounded-2xl p-6 text-center">
                ...
                <h3 className="font-bold text-foreground text-lg mb-2">Código de Referência</h3>
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 mb-4 border-2 border-dashed border-primary/30">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-4">
                <div className="flex justify-between items-center">
                  <span className="text-foreground font-medium">Valor a pagar</span>
              ...
              <div className="bg-muted/30 rounded-xl p-4 space-y-3">
                ...
                <ol className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex gap-2">
                    ...
                    <span>Acesse seu aplicativo ou agência bancária</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="font-bold text-primary">2.</span>
                    <span>Selecione a opção de pagamento por referência</span>
                  </li>
                  <li className="flex gap-2">
                  ...
                  <li className="flex gap-2">
                    ...
                    <span>Confirme o pagamento do valor exato</span>
                  </li>
                </ol>
              </div>
